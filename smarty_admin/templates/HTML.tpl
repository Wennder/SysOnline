...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br" lang="pt-br">
    <head>
        ...
        <script language="javascript" type="text/javascript" src="{$smarty.const.HTTP_URL}js/admin/GestaoFuncionarios.class.js"></script>
        <script language="javascript" type="text/javascript" src="{$smarty.const.HTTP_URL}js/admin/GestaoCampi.class.js"></script>
        <script language="javascript" type="text/javascript" src="{$smarty.const.HTTP_URL}js/admin/GestaoCargos.class.js"></script>
	    <script language="javascript" type="text/javascript" src="{$smarty.const.HTTP_URL}js/admin/GestaoCurso.class.js"></script>
    ...
    <body>
        <div id="wrapper">
            <div id="gif_load" style="visibility:hidden">
                <img src="{$smarty.const.HTTP_URL}imagem/admin/ajax-loader.gif" title="Carregando..." />
            </div>
            <div id="topo">
                <div id="logo">
