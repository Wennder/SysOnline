<div class="icons">
    <ul>
        <li><span id="add"><a href="javascript:;" onclick="GestaoFuncionarios.initCad()" title="Incluir Novo Funcionário"><img src="{$smarty.const.HTTP_URL}imagem/admin/add_user.png" alt=""/>Incluir Novo</a></span></li>
        <li><span id="delete"><a href="javascript:;" onclick="GestaoFuncionarios.execDel()" title="Deletar Funcionários"><img src="{$smarty.const.HTTP_URL}imagem/admin/delete_user.png" alt=""/>Deletar Seleção</a></span></li>
        <li>
            <span id="busca">
        ...
        <li>
            <span id="relatorio">
                <a href="javascript:;" onclick="js.showReports()" title="Gerar relatório"><img src="{$smarty.const.HTTP_URL}imagem/admin/tableExcel.png" alt=""/>Gerar relatórios</a>
            </span>
        </li>
    </ul>
</div>
