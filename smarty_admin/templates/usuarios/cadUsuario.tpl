<div class="icons">
    <ul>
        <li><span id="save"><a href="javascript:;" id="formSaveUsuario_submit" onclick="GestaoUsuarios.cadUsuario(); return false" title="Salvar"><img src="{$smarty.const.HTTP_URL}imagem/admin/save.png" alt=""/>Salvar</a></span></li>
        <li><span id="cancel"><a href="javascript:;" onclick="GestaoUsuarios.initList(); return false" title="Cancelar"><img src="{$smarty.const.HTTP_URL}imagem/admin/cancel.png" alt=""/>Cancelar</a></span></li>
    </ul>
</div>
<fieldset class="all">
    ...
    <form action="" method="post" id="formSaveUsuario" onsubmit="GestaoUsuarios.cadUsuario(); return false">
        ...
        <div class="field">
            ...
            <input id="formSaveUsuario_nome" name="nome" type="text" class="input_text" value="{$usuarioInfo.nome}" title="Digite seu Nome"/>
...
<div class="icons">
    ...
    <ul>
        <li><span id="save"><a href="javascript:;" onclick="GestaoUsuarios.cadUsuario(); return false" title="Salvar"><img src="{$smarty.const.HTTP_URL}imagem/admin/save.png" alt=""/>Salvar</a></span></li>
        <li><span id="cancel"><a href="javascript:;" onclick="GestaoUsuarios.initList(); return false" title="Cancelar"><img src="{$smarty.const.HTTP_URL}imagem/admin/cancel.png" alt=""/>Cancelar</a></span></li>
    </ul>
</div>